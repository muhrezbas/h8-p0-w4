...
for(var i = 0; i < products.length; i++){
  ...
  else if(uangSekarang>=products[i].price) {
    obj.listPurchased.push(products[i].name)
    uangSekarang = uangSekarang - products[i].price
      //  console.log(uangSekarang)
       obj.changeMoney = uangSekarang
      }
}
